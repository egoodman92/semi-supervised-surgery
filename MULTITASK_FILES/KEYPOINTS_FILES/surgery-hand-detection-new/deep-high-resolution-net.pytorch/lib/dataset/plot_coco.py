...
_RED = (1.0, 0, 0)
_BLUE = (0, 0, 1.0)
_PURPLE = (153 / 255, 0, 204 / 255)
_ORANGE = (255 / 255, 153 / 255, 51 / 255)
_LBROWN = (230 / 255, 153 / 255, 0)


link_pairs = [[1,2],[2,3],[3,4],
              [4,5],[6,7],[7,8],
              [8,9],[10,11],[11,12],
              [12,13],[14,15],[15,16],
              [16,17],[18,19],[19,20],
...
def plot(data, gt_file, img_path, save_path, save=True):
    ...
    coco_eval = PCKCOCOeval(coco, coco_dt, 'keypoints')
    coco_eval._prepare()
    gts_ = coco_eval._gts
    dts_ = coco_eval._dts
    ...
    for catId in catIds:
        for imgId in p.imgIds[:]:
            ...
            img_name = coco.imgs[imgId]['file_name'][:-4]
...
if __name__ == '__main__':
    ...
    plot(data, gt_file, img_path, save_path, save=True)
