...
def parse_args():
    parser = argparse.ArgumentParser(description='PCK analysis by category')
    # general
...
def main():
    ...
    with open("pck_category_analysis_" + ("gt" if args.use_gt else "dt") + ("_test" if args.test else "") + ".txt", "w") as file:
