...
#     accept_images = json.load(open('/home/ubuntu/surgery-tool-detection/src/util/acceptable_images.json')) ##
#     bad_images = accept_images['bad_images'] ##
#     bad_images += bad_scalpels ## 
    
    accept_images = json.load(open('/home/ubuntu/surgery-tool-detection/src/pytorch-retinanet/pruning.json')) ##
    bad_images = accept_images['bad'] ## 
