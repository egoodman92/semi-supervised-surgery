...
class BatchLogger(): 
    def __init__(self): 
        ...
        self.index = None 
        self.tool = {'bovie': [0, 0], 'forceps': [0, 0], 'needledriver': [0, 0], 'hand': [0, 0], 'background': [0, 0]} #defaultdict(int) 
        self.tool_frame = {'bovie': [0, 0], 'forceps': [0, 0], 'needledriver': [0, 0], 'hand': [0, 0], 'background': [0, 0]} #defaultdict(int) 
